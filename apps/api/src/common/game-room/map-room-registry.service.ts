...
export interface RoomWithMappedPlayers<P extends { socketId: string }> extends BaseRoom {
 ...
 * Provides concrete `addPlayer`, `removePlayer`, and `rebindSocket` implementations.
