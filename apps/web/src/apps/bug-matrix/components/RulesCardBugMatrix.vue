<template>
  <div class="bg-white rounded-2xl border border-stone-200 p-5 flex flex-col gap-3">
    ...
    <ul class="text-sm text-stone-600 space-y-2 list-disc pl-4">
      ...
      <li>À la fin, vous votez pour chaque joueur : <b>NORMAL</b>, ou la catégorie de règle que vous devinez (<b>FORM</b>, <b>TONE</b>, <b>CONTENT</b>).</li>
      <li>+2 si tu trouves le Normal · +3 si moins de la moitié t'a trouvé en tant que Normal · +1 par voteur trompé sur toi · +1 par catégorie correctement devinée.</li>
    </ul>
  </div>
</template>
