<template>
  <div class="flex flex-col gap-1.5">
    <p class="text-xs font-semibold text-foreground-subtle uppercase tracking-widest mb-1">Joueurs</p>
    <div
    ...
    >
      <div class="flex items-center justify-between gap-2">
        <span class="font-semibold text-foreground truncate">{{ player.pseudo }}</span>
...
function hopColor(status: string): string {
  return (
    {
      CONNECTED: 'text-foreground-muted',
